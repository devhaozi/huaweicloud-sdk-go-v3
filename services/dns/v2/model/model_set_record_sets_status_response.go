...
// SetRecordSetsStatusResponse Response Object
...
func (o SetRecordSetsStatusResponse) String() string {
	...
	if err != nil {
		return "SetRecordSetsStatusResponse struct{}"
	}

	return strings.Join([]string{"SetRecordSetsStatusResponse", string(data)}, " ")
}
